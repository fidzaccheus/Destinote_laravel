...
@section('title', 'My Destinations - Destinote')
        ...
        <div class="container">
            ...
            @if(request()->get('verified'))
                <div class="alert alert-success alert-dismissible fade show mb-4" role="alert">
                    ...
                    <strong>Email Verified!</strong> Your email has been successfully verified. Welcome to Destinote!
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('destinations.create') }}" class="btn btn-lg fw-semibold" id="start-journey-btn">
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0 bg-success text-white">
                        <div class="card-body text-center py-3">
                            ...
                            <h3 class="h2 fw-bold mb-1">{{ $stats['completed'] }}</h3>
                ...
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0 bg-warning text-white">
                        <div class="card-body text-center py-3">
                            ...
                            <h3 class="h2 fw-bold mb-1">{{ $stats['noted'] }}</h3>
                            <p class="mb-0 small">Noted (Dreaming)</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card h-100 shadow-sm border-0 bg-info text-white">
                        <div class="card-body text-center py-3">
                            <i class="bi bi-flag-fill fs-2 mb-2"></i>
                            <h3 class="h2 fw-bold mb-1">{{ $stats['countries'] }}</h3>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm border-0"
                            ...
                            <div class="card-body text-center text-white py-3">
                                ...
                                <h4 class="h3 fw-bold mb-1">₱{{ number_format($stats['total_budget'], 2) }}</h4>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm border-0"
                            ...
                            <div class="card-body text-center text-white py-3">
                                ...
                                <h4 class="h3 fw-bold mb-1">₱{{ number_format($stats['avg_budget'], 2) }}</h4>
                                <p class="mb-0 small">Average Budget</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100 shadow-sm border-0"
                            ...
                            <div class="card-body text-center text-white py-3">
                                ...
                                <h4 class="h3 fw-bold mb-1">{{ $stats['upcoming'] }}</h4>
                                <p class="mb-0 small">Upcoming Trips</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="col-md-6 text-center">
                        <div class="card shadow-lg border-0 p-5">
                            ...
                            <p class="text-muted mb-4">Start building your travel bucket list by adding your first destination!
                            </p>
                            <a href="{{ route('destinations.create') }}" class="btn btn-lg fw-semibold" id="start-journey-btn">
