...
<head>
    ...
    <title>Add Destination - Destinote</title>
</head>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-4">
                        <h1 class="display-5 fw-bold mb-2">
                            <i class="bi bi-plus-circle text-info"></i> Add New Destination
                        </h1>
                        <p class="text-muted">Fill in the details about your dream destination</p>
                    </div>
                            ...
                            <form action="{{ route('destinations.store') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="destination_name" id="destination_name"
                                        ...
                                        placeholder="e.g., Eiffel Tower, Boracay Beach" required>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="country" id="country" value="{{ old('country') }}"
                                            ...
                                            placeholder="e.g., France, Philippines" required>
                                        @error('country')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="city" id="city" value="{{ old('city') }}"
                                            class="form-control" placeholder="e.g., Paris, Boracay">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="description" rows="4" class="form-control"
                                        placeholder="What makes this destination special? What do you want to do there?">{{ old('description') }}</textarea>
                                    <small class="text-muted">Share your thoughts and plans for this destination</small>
                                </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="budget" id="budget" step="0.01"
                                            value="{{ old('budget') }}" class="form-control" placeholder="0.00">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="tag" id="tag" value="{{ old('tag') }}"
                                            class="form-control" placeholder="e.g., Beach, Adventure, Cultural">
                                        <small class="text-muted">Categorize your destination</small>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="status" id="status" class="form-select" required>
                                            <option value="Noted" {{ old('status') === 'Noted' ? 'selected' : '' }}>📝
                                                Noted (Dreaming)</option>
                                            <option value="Completed" {{ old('status') === 'Completed' ? 'selected' : '' }}>✅ Completed (Visited)</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    <label for="image" class="form-label fw-semibold">
                                        <i class="bi bi-image text-primary"></i> Destination Image
                                    </label>
                                    <input type="file" name="image" id="image" class="form-control" accept="image/*"
                                        onchange="previewImage(event)">
                                    <small class="text-muted">Upload a photo of your destination (JPG, PNG, GIF)</small>
                                ...
                                <div class="d-flex gap-3 mt-5">
                                    ...
                                    <button type="submit" class="btn btn-lg fw-semibold flex-fill"
                                        ...
                                        <i class="bi bi-check-circle me-2"></i>Add Destination
                                    </button>
                                </div>
                            </form>
                        </div>
